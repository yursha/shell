...
int jobs_builtin(WORD_LIST *list) {
  ...
  if (execute) return (execute_list_with_replacements(list));
...
static int execute_list_with_replacements(list) WORD_LIST *list;
{
...
#if defined(JOB_CONTROL)
int disown_builtin(WORD_LIST *list) {
