...
#define W_NOSPLIT                                                             \
  0x000010 /* Do not perform word splitting on this word because ifs is empty \
              string. */
#define W_NOGLOB 0x000020 /* Do not perform globbing on this word. */
#define W_NOSPLIT2                                                            \
  0x000040 /* Don't split word except for $@ expansion (using spaces) because \
...
#define W_NOCOMSUB \
  0x000400 /* Don't perform command substitution on this word */
...
#define W_ASSNBLTIN \
  0x010000 /* word is a builtin command that takes assignments */
...
#define W_ASSIGNASSOC \
  0x400000 /* word looks like associative array assignment */
#define W_ASSIGNARRAY \
  0x800000 /* word looks like a compound indexed array assignment */
#define W_ARRAYIND 0x1000000 /* word is an array index being expanded */
#define W_ASSNGLOBAL \
  0x2000000 /* word is a global assignment to declare (declare/typeset -g) */
