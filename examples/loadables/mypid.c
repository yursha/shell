...
static SHELL_VAR *assign_mypid(SHELL_VAR *self, char *value, arrayind_t unused,
                               char *key) {
  return (self);
}
...
void enable_mypid_builtin_unload(char *s) { unbind_variable("MYPID"); }

char const *enable_mypid_doc[] = {
    "Enable $MYPID.", "", "Enables use of the ${MYPID} dynamic variable.  ",
