...
struct timeval *difftimeval(d, t1, t2) struct timeval *d, *t1, *t2;
{
...
struct timeval *addtimeval(d, t1, t2) struct timeval *d, *t1, *t2;
{
...
int timeval_to_cpu(rt, ut, st) struct timeval *rt, *ut,
    *st; /* real, user, sys */
{
  ...
  for (i = 0; i < 6; i++) {
    if ((t1.tv_sec > 99999999) || (t2.tv_sec > 99999999)) break;
    t1.tv_sec *= 10;
