...
static int _path_readlink(path, buf, bufsiz) char *path;
char *buf;
int bufsiz;
{
#ifdef HAVE_READLINK
...
char *sh_physpath(path, flags) char *path;
int flags;
{
