...
extern mr_table_t *mr_table_entry(void *);
extern void mregister_alloc(const char *, void *, size_t, const char *, int);
extern void mregister_free(void *, int, const char *, int);
