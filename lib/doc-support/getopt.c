...
/* Copyright (C) 1987, 88, 89, 90, 91, 92, 1993, 2008,2009 Free Software
   Foundation, Inc.
...
#define alloca __builtin_alloca
    ...
    (defined(sparc) && (defined(sun) || (!defined(USG) && !defined(SVR4) && \
                                         !defined(__svr4__))))
#include <alloca.h>
#else
#ifndef _AIX
...
static void my_bcopy(from, to, size) const char *from;
char *to;
int size;
{
  int i;
