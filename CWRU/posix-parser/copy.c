...
WORD_DESC *copy_word(word) WORD_DESC *word;
{
...
PATTERN_LIST *copy_case_clause(clause) PATTERN_LIST *clause;
{
...
PATTERN_LIST *copy_case_clauses(clauses) PATTERN_LIST *clauses;
{
...
FOR_COM *copy_for_command(com) FOR_COM *com;
{
...
GROUP_COM *copy_group_command(com) GROUP_COM *com;
{
...
CASE_COM *copy_case_command(com) CASE_COM *com;
{
...
WHILE_COM *copy_while_command(com) WHILE_COM *com;
{
...
IF_COM *copy_if_command(com) IF_COM *com;
{
...
SIMPLE_COM *copy_simple_command(com) SIMPLE_COM *com;
{
