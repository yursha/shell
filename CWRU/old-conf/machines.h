...
#define SYSDEP_CFLAGS \
  -DOPENDIR_NOT_ROBUST - DINT_GROUPS_ARRAY - DRLIMTYPE = quad_t
...
#define M_OS "SunOS5"
#define SYSDEP_CFLAGS                                                \
  -DUSGr4 - DUSG - DSolaris - DOPENDIR_NOT_ROBUST - DSBRK_DECLARED - \
      DINT_GROUPS_ARRAY
...
#define M_OS "SunOS4"
#define SYSDEP_CFLAGS \
  -DHAVE_BSD_PGRP - DOPENDIR_NOT_ROBUST - DTERMIOS_LDISC - DINT_GROUPS_ARRAY
#define HAVE_DIRENT
#define HAVE_DLOPEN
#define HAVE_DLSYM
#define HAVE_DLCLOSE
...
#endif /* !MIPSEL */
#define SYSDEP_CFLAGS \
  -DHAVE_BSD_PGRP - DTERMIOS_MISSING - DTERMIOS_LDISC - DINT_GROUPS_ARRAY
#define M_OS "Ultrix"
#define HAVE_DIRENT
#define VOID_SIGHANDLER
#define HAVE_SYS_SIGLIST
...
#define SGI_CFLAGS                                                       \
  -DUSG - DPGRP_PIPE - DHAVE_BCOPY - DHAVE_GETPW_DECLS - DHAVE_SOCKETS - \
      DSBRK_DECLARED
#else
#define SGI_CFLAGS \
  -DUSG - DPGRP_PIPE - DHAVE_BCOPY - DHAVE_GETPW_DECLS - DHAVE_SOCKETS
...
#define M_OS "Dynix"
#define DYNIX_CFLAGS \
  -DHAVE_GETDTABLESIZE - DHAVE_SETDTABLESIZE - DHAVE_GETPW_DECLS - DHAVE_SOCKETS
...
#endif
#define ISC_SYSDEPS                                           \
  -DUSGr3 - DPGRP_PIPE - DHAVE_GETPW_DECLS - D_POSIX_SOURCE - \
      DOPENDIR_NOT_ROBUST - DMEMMOVE_MISSING
#if defined(__STDC__)
#if defined(HAVE_GCC)
...
#define M_OS "Linux"
#define SYSDEP_CFLAGS \
  -DHAVE_GETDTABLESIZE - DHAVE_BCOPY - DHAVE_GETPW_DECLS - DHAVE_GETHOSTNAME
...
#define LD_HAS_NO_DASH_L
#define SYSDEP_CFLAGS \
  -DTERMIOS_MISSING - DMKFIFO_MISSING - DHAVE_BSD_PGRP - DRLOGIN_PGRP_BUG - w
...
#define M_OS "Linux"
#define SYSDEP_CFLAGS                                                      \
  -DUSG - DUSGr3 - DHAVE_GETDTABLESIZE - DHAVE_BCOPY - DHAVE_GETPW_DECLS - \
      DHAVE_GETHOSTNAME
#define REQUIRED_LIBRARIES
#define HAVE_GETGROUPS
#define HAVE_STRERROR
...
#undef HAVE_RESOURCE
#define HPUX_CFLAGS \
  -DSBRK_DECLARED - DHAVE_SOCKETS - DHAVE_GETHOSTNAME HPUX_ANSI
#endif /* HPUX_9 */
...
#define VOID_SIGHANDLER
#define SYSDEP_CFLAGS                                              \
  -q ext = pcc - D_POSIX_JOB_CONTROL - D_POSIX_VERSION - Dmalloc = \
               _malloc - Dfree = _free - Drealloc = _realloc
...
#define M_OS "Bsd"
#define SYSDEP_CFLAGS                                                \
  -D_POSIX_VERSION - D_INCLUDE_BSD_SOURCE - D_INCLUDE_POSIX_SOURCE - \
      DTERMIOS_MISSING - DHAVE_BSD_PGRP - Dpid_t = int
#define HAVE_SYS_SIGLIST
#define HAVE_SETLINEBUF
#define HAVE_GETGROUPS
#endif /* apollo */
...
#define M_OS "USG"
#define SYSDEP_CFLAGS \
  -g - Xa - v - Dgetwd = bash_getwd - D_POSIX_SOURCE - D_POSIX_JOB_CONTROL
#define USE_TERMCAP_EMULATION
#define HAVE_VPRINTF
#define HAVE_GETGROUPS
#define VOID_SIGHANDLER
...
#define M_OS "USG"
#define SYSDEP_CFLAGS \
  -DUSG - DUSGr3 - DHAVE_BCOPY - DHAVE_UID_T - D_POSIX_JOB_CONTROL
/* #  define REQUIRED_LIBRARIES -lPW -lposix */
#define HAVE_DIRENT
#define VOID_SIGHANDLER
...
#define M_OS "Unicos"
#define SYSDEP_CFLAGS \
  -DUSG - DPGRP_PIPE - DOPENDIR_NOT_ROBUST - DHAVE_BCOPY CRAY_STACK
#define HAVE_VPRINTF
